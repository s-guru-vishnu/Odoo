...
const { getCategories, getCourses, getBlogPosts, getCommunityUsers, getChannels, createChannel, getChannelMessages, postMessage } = require('../controllers/publicController');
